...
from nnunet.network_architecture.generic_UNetPlusPlus2 import Generic_UNetPlusPlus2
from nnunet.paths import *


class ExperimentPlanner3D_UNetPlusPlus2(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_UNetPlusPlus2, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        ref = Generic_UNetPlusPlus2.use_this_for_batch_size_computation_3D * self.unet_base_num_features / \
              Generic_UNetPlusPlus2.BASE_NUM_FEATURES_3D
        here = Generic_UNetPlusPlus2.compute_approx_vram_consumption(new_shp, network_num_pool_per_axis,
        ...
        batch_size = Generic_UNetPlusPlus2.DEFAULT_BATCH_SIZE_3D  # This is what wirks with 128**3

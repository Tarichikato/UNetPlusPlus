...
class nnUNetPlusPlus3TrainerV2(nnUNetTrainer):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        # Modification par JB, initialement 1e-2
        # self.initial_lr = 1e-2
        self.initial_lr = 1e-3
        #self.initial_lr = 3e-4
        self.weight_decay = 1e-5 # Modification par JB. Initialement non défini
    ...
    def initialize_network(self):
        ...
        # Modification par JB : initialement, 'p': 0
        #dropout_op_kwargs = {'p': 0, 'inplace': True}
        dropout_op_kwargs = {'p': 0.5, 'inplace': True}
        net_nonlin = nn.LeakyReLU
        net_nonlin_kwargs = {'negative_slope': 1e-2, 'inplace': True}
        self.network = Generic_UNetPlusPlus3(self.num_input_channels, self.base_num_features, self.num_classes,

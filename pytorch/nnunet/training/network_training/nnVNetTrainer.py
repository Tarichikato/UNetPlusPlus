...
from nnunet.network_architecture. import PlainConvVNet
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_VNet(self.num_input_channels, self.base_num_features, self.num_classes, net_numpool,
    ...
    def run_training(self):
        ...
        super(nnVNetTrainer, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(nnVNetTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()

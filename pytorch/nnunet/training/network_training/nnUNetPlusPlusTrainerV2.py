...
class nnUNetPlusPlusTrainerV2(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        if self.threeD:
            ...
            # Modification par JB : InstanceNorm3d par défaut
            ...
            # Modification par JB : InstanceNorm2d par défaut
            #norm_op = nn.InstanceNorm2d
            norm_op = nn.BatchNorm2d
        norm_op_kwargs = {'eps': 1e-5, 'affine': True}
        # Modification par JB : par défaut, 'p': 0
    ...
    def initialize_optimizer_and_scheduler(self):
        ...
        sys.stdout.flush()
        # Modification par JB : initialement, SGD

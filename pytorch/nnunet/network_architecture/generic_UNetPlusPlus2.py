...
# Version avec suppression possible du dernier niveau
...
class Generic_UNetPlusPlus2(SegmentationNetwork):
    # Modification par JB : 2 par défaut
    ...
    #use_last_level = False
    
    # Ajout par JB de l'argument use_last_level initialisé à False
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
                 ...
                 seg_output_use_bias=False, use_last_level=False):
        """
        ...
        """
        super(Generic_UNetPlusPlus2, self).__init__()
